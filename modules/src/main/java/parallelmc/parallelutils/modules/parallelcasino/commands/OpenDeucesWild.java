...
import parallelmc.parallelutils.modules.parallelcasino.games.deuceswild.DeucesWildInventory;
import parallelmc.parallelutils.modules.parallelchat.ParallelChat;
import parallelmc.parallelutils.util.GUIManager;

public class OpenDeucesWild implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String label, @NotNull String[] args)
    {
        if (commandSender instanceof Player player) {
            ...
            GUIManager.get().openInventoryForPlayer(player, new DeucesWildInventory());
